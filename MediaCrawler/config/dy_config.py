...
DY_SPECIFIED_ID_LIST = [
    # Dán link video vào đây nếu chạy main.py trực tiếp; tool cao_video.py sẽ tự truyền link qua --specified_id
]
...
DY_CREATOR_ID_LIST = [
    # Dán link kênh vào đây nếu chạy main.py trực tiếp; tool cao_video.py sẽ tự truyền link qua --creator_id
]
