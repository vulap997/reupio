...
def parse_video_info_from_url(url: str) -> VideoUrlInfo:
    ...
    # Định dạng av: /video/av<aid> hoặc 'av<aid>' truyền thẳng. Kết quả SEARCH bilibili chỉ có aid
    # (KHÔNG có bvid) -> Xem-trước tạo URL dạng av -> PHẢI parse được, kẻo "Cào video đã chọn" tải 0 video.
    # Giữ tiền tố 'av' để get_specified_videos route sang tham số aid (get_video_info nhận aid HOẶC bvid).
    if re.fullmatch(r"av\d+", url.strip()):
