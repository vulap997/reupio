...
async def update_xhs_note_video(note_id, video_content, extension_file_name, sub_dir=""):
    """
    ...
    await XiaoHongShuVideo().store_video({"notice_id": note_id, "video_content": video_content, "extension_file_name": extension_file_name, "sub_dir": sub_dir})
